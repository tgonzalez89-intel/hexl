...
void CkksSwitchKey(uint64_t* result, const uint64_t* t_target_iter_ptr,
  ...
  intel::hexl::cpu::CkksSwitchKey(result, t_target_iter_ptr, n, decomp_modulus_size, key_modulus_size, rns_modulus_size, key_component_count, moduli, k_switch_keys, modswitch_factors);
}
